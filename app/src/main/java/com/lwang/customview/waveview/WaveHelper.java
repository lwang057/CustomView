...
public class WaveHelper {
    ...
    public WaveHelper(WaveView aveView, int behindWaveColor, int frontWaveColor, View view) {
    ...
    private void initAnimation() {
        ...
        final ObjectAnimator waterLevelAnim = ObjectAnimator.ofFloat(
                mWaveView, "waterLevelRatio", mDefaultWaterLevelRatioF, mDefaultWaterLevelRatioT);
        ...
        mAmplitudeAnim = ObjectAnimator.ofFloat(
                mWaveView, "amplitudeRatio", mDefaultAmplitudeRatioF, mDefaultAmplitudeRatioT);
...
//                mFloatView.setRotation(value + mDefaultFloatViewRotation);
        ...
        if (mAnimatorSet != null && !mHasStart) {
            ...
            if (amplitudeChangeAnim != null) {
                amplitudeChangeAnim = ObjectAnimator.ofFloat(
                        mWaveView, "amplitudeRatio", 0.00001f, mDefaultAmplitudeRatioF);
    ...
    public void cancel() {
        ...
        if (mAnimatorSet != null && !mHasCancel) {
            ...
            amplitudeChangeAnim = ObjectAnimator.ofFloat(
                    mWaveView, "amplitudeRatio", mDefaultAmplitudeRatioT, 0.00001f);
            amplitudeChangeAnim.setDuration(1000);
            amplitudeChangeAnim.start();
